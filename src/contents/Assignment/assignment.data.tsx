...
export const BUS_STATUS = new Map([
  ["1", { label: "包車", color: "B400", background: "G50" }],
  ["2", { label: "保養", color: "B400", background: "Y50" }], 
  ["3", { label: "需求變更", color: "R400", background: "R50" }],
]);
