...
import { getBusData, getBusTitle, I_BusData } from "@services/assignment/getRecommendCar";
    ...
    const changeKey = (data: Array<any>) => {
        return data.map((item: any) => {
          return {
            ...
            prev_end_info: (<div className="stop_info">
                <p>{item.prev_end_dt}</p>
                <p>{item.prev_end_location}</p>
            </div>),
            next_begin_info: (<div className="stop_info">
