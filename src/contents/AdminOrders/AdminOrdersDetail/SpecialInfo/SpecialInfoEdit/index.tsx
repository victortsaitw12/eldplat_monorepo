    ...
    return (
        <BodySTY>
            <Pane style={{ padding: "20px", display: "flex", flexWrap: "wrap" }}>
                ...
                <Pane style={{ width: "50%", marginBottom: "20px", padding: "10px" }}>
                    <CheckBoxWrapper checked={true} description="" label="司導（NT$200）" />
                </Pane>
                <Pane style={{ width: "50%", marginBottom: "20px", padding: "10px" }}>
                    <CheckBoxWrapper checked={true} description="" label="瓶裝水（NT$120/箱）" >
                        <Pane style={{ paddingLeft: "30px" }}>
                            <VerticalDetail
                                title=""
                                items={[
                                    {
                                        label: "",
                                        value: <CounterInput register={register} inpurName="counter-01" label="24瓶/箱" />
                                    }
                                ]}
                            />
                        </Pane>
                ...
                <Pane style={{ width: "50%", marginBottom: "20px", padding: "10px" }}>
                    <CheckBoxWrapper checked={true} description="" label="指定車齡（視選項加價）" >
                        <Pane style={{ paddingLeft: "30px" }}>
                            <CustomSelect
                                selectName="bus-age"
                                register={register}
                        ...
                        <Pane style={{ paddingLeft: "30px" }}>
                            <VerticalDetail
                                ...
                                items={[
                                    {
                                        label: "",
                                        value: <CounterInput register={register} inpurName="counter-01" label="由店家提供（+NT$200/ 天）" />
                                    },
                                    {
                                        label: "",
                                        value: <CounterInput register={register} inpurName="counter-01" label="自備" />
                                    }
                                ]}
                            />
                        </Pane>
                ...
                <Pane style={{ width: "50%", marginBottom: "20px", padding: "10px" }}>
                    <CheckBoxWrapper checked={true} description="" label="攜帶特大/特殊行李" />
                </Pane>
                <Pane style={{ width: "50%", marginBottom: "20px", padding: "10px" }}>
